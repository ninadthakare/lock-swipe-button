...
public class SwipeButton extends RelativeLayout implements View.OnTouchListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        disabledDrawable = ContextCompat.getDrawable(context, R.drawable.ic_lock_outline_black_24dp);
        enabledDrawable = ContextCompat.getDrawable(context, R.drawable.ic_lock_open_black_24dp);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (event.getX() > initialX + slidingButton.getWidth() / 2 &&
                    ...
                    centreText.setAlpha(1 - 1.3f * ((slidingButton.getX() +
    ...
    private void expandButton() {
        ...
        widthAnimator.addUpdateListener(animation -> {
            ...
            params.width = (int) widthAnimator.getAnimatedValue();
    ...
    private void collapseButton() {
        final ValueAnimator widthAnimator = ValueAnimator.ofInt(slidingButton.getWidth(),
                initialButtonWidth);
        widthAnimator.addUpdateListener(animation -> {
            ViewGroup.LayoutParams params = slidingButton.getLayoutParams();
            params.width = (int) widthAnimator.getAnimatedValue();
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(centreText, "alpha", 1);
        AnimatorSet animatorSet = new AnimatorSet();
